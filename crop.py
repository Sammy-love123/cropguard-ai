...
with st.sidebar:
    ...
    st.markdown("<div style='font-size:13px;line-height:1.9;opacity:0.9;'>🌾 <b>Crops Covered:</b><br>&nbsp;&nbsp;🟤 Cassava (4 classes)<br>&nbsp;&nbsp;🌽 Maize (7 classes)<br>&nbsp;&nbsp;🍠 Yam (4 classes)<br><br>🤖 <b>Best Model:</b> VGG16<br>🎯 <b>Accuracy:</b> 93.30%<br>🏷️ <b>Total Classes:</b> 15</div><hr style='border-color:rgba(255,255,255,0.2);margin:15px 0;'>", unsafe_allow_html=True)
